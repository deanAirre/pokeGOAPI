...
This API uses Go and PostgreSQL stack, to use this API, readers must at least preinstall things listed below:

1. `postgresql-server` and `postgresql-contrib`, tested using
